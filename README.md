...
## BETA
This version includes 4 new features:
...
* Tracks raid trades
* Show roll popup for everyone when loot master starts a roll. Enable with `/rf config client show-roll Eligible` or `Always`
